                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <h3 class="text-success">KSH<?php echo e(!$wallet ? 0 : number_format($wallet->amount)); ?></h3>
                                    ...
                                    <table id="myTabl" class="table table-bordered table-striped">
                                        ...
                                        <?php $__currentLoopData = $trans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tran): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td class="btn btn-outline-danger"><?php echo e($tran->status); ?></td> 
                                                <?php else: ?>
                                                <td class="btn btn-success waves-effect waves-light"><?php echo e($tran->status); ?></td> 
                                                <?php endif; ?>                                            
