...
<?php if(Auth::user()->level < 1): ?>
     ...
     <span class="m-b-0 text-dark"><br>MAKE PAYMENT TO PAYBILL : (EARNERS TECNOLOGIES)<br>ACCOUNT NO : YOUR USERNAME<br><strong>IF NOT ACTIVATED  IN 5MINS AFTER PAYMENT WHATSAPP OR CALL 0766206081</strong> 
     </span>
     </div>
                                ...
                                <table class="table mt-3">
                                    ...
                                    <tbody>
                                        ...
                                        <tr >
                                            ...
                                            <td class="text-success">KSH<?php echo e(number_format($transIn)); ?></td>
                                        </tr>
                                      
                                        <tr >
                                            <td>Total Withdrawal:</td>
                                            <td class="text-danger">KSH<?php echo e(number_format($transOut)); ?></td>
                                        </tr>
                                        <tr >
                                            <td>Joined:</td>
                                        ...
                                        <tr >
                                            <td>Referral Link:</td>
                                            <td><a class="text-info" href="https://e-earners.co.ke/register?ref=<?php echo e(Auth::user()->username); ?>">https://e-earners.co.ke/register?ref=<?php echo e(Auth::user()->username); ?></a></td>
                                        </tr>
                                        <?php endif; ?>
                                    </tbody>
                                </table>
